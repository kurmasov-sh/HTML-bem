...
window.onload = function() {
  ...
  let coordXprocent = 0; let coordYprocent = 0;
  ...
  const menuArray = ['Прямая трансляция', 'Ханты-Мансийск', 'Новости', 'Участники', 'Основная информация', 'Результаты', 'Медиа', 'Контакты'];
  const subMenuArray = ['О Ханты-Мансийске', 'История кубка мира', 'Информация для участников'];
